#ifndef __LCD_BOARD_1_CONFIG_H_
#define __LCD_BOARD_1_CONFIG_H_
//戴家昀四层板 吴添恒显示屏
/****************************************/
/*** LCD ***/
#define LCD_CONGIG
...
//LIGHT
#define RCC_LCD_LIGHT   RCC_APB2Periph_GPIOB
#define LCD_LIGHT_GPIO  GPIOB
#define LCD_LIGHT_Pin   GPIO_Pin_9
...
#define LCD_TOUCH_PEN_Pin  GPIO_Pin_7

#define RCC_LCD_TOUCH_TCS  RCC_APB2Periph_GPIOB
#define LCD_TOUCH_TCS_GPIO GPIOB
#define LCD_TOUCH_TCS_Pin  GPIO_Pin_6
//与触摸屏芯片连接引脚
#define PEN     PBin(7)      //PF10 INT
#define TCS     PBout(6)     //PB2  CS
